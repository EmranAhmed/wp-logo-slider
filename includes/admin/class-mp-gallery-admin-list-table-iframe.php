<?php
	...
	class MP_Gallery_Admin_List_Table_Iframe extends WP_List_Table {

		private $post_type = 'mp-gallery';
		private $per_page  = 10;
		...
		public function get_columns() {
			...
			$posts_columns[ 'grid_column' ]      = _x( 'Grid Column', 'column name' );
			$posts_columns[ 'gallery_template' ] = _x( 'Template', 'column name' );
			$posts_columns[ 'add_button' ]       = _x( 'Action', 'column name' );

			return $posts_columns;
			//return apply_filters( "manage_{$this->post_type}_posts_columns", $posts_columns );
		...
		public function column_default( $post, $column_name ) {
			switch ( $column_name ) {
				...
				case 'gallery_template':
					...
					break;
				case 'add_button':
					echo '<a class="button button-primary" onclick="addMPGalleryShortCode.insert(\'' . get_the_ID() . '\')" href="javascript:;">Insert</a>';
					break;
			}
